...
def skipgrams(sentence):
    # Skip-grams: ["I sell", "I seashells","I by","I seashore","I which","I are","I seashells","I by,"I seashore"]
    sentenceSkipGramRepresentations = []
    # Get the base word.
    ...
    sentenceSkipGramRepresentations.append(skipGrams)
    return sentenceSkipGramRepresentations
