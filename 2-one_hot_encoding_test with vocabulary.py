...
>>> from sklearn.preprocessing import LabelBinarizer
>>> binarizer = LabelBinarizer().fit(list(vocabulary))
>>> # Testing whether I need to use apply or Ican just use str.split
>>> Y = binarizer.transform(X[1].str.split(" "))
Traceback (most recent call last):
  File "<pyshell#23>", line 1, in <module>
    Y = binarizer.transform(X[1].str.split(" "))
  File "/Users/montana/miniconda3/lib/python3.6/site-packages/sklearn/preprocessing/label.py", line 330, in transform
    y_is_multilabel = type_of_target(y).startswith('multilabel')
  File "/Users/montana/miniconda3/lib/python3.6/site-packages/sklearn/utils/multiclass.py", line 263, in type_of_target
    raise ValueError('You appear to be using a legacy multi-label data'
ValueError: You appear to be using a legacy multi-label data representation. Sequence of sequences are no longer supported; use a binary array or sparse matrix instead.
>>> Y = binarizer.transform(X[1].str.split(" ").values)
Traceback (most recent call last):
